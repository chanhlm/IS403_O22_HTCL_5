...
\begin{document}
	...
	\begin{table}[H]
		...
		\begin{tabular}{|c|c|c|c|c|}
			...
			\hline
			\multirow{2}{*}
			{LSTM} & 7:3 & 1942.57 & 3.59 & 1610.65 \\ & 8:2 & 1584.43 & 3.19 & 1327.38 \\ & \textbf{9:1} & \textbf{620.8} & \textbf{1.11} & \textbf{453.75}\\
			\hline
			\multirow{2}{*}
			{GRU} & 7:3 & 1066.36 & 1.61 & 768.15 \\ & 8:2 & 852.96 & 1.40 & 591.53 \\ & \textbf{9:1} & \textbf{583.23} & \textbf{0.94} & \textbf{386.74}\\
			\hline
			\multirow{2}{*}
			{MPL} & 7:3 &  &  &  \\ & 8:2 &  &  &  \\ & \textbf{9:1} & \textbf{} & \textbf{} & \textbf{}\\
			\hline
		\end{tabular}
	...
	\begin{figure}[H]
		...
		\begin{minipage}{0.9\linewidth}
			\centering
			\includegraphics[width=\linewidth]{bibliography/result/VHM_SVM_82.png}
	...
	\begin{table}[H]
		...
		\begin{tabular}{|c|c|c|c|c|}
			...
			\hline
			\multirow{2}{*}
			{LSTM} & 7:3 & 2105.96 & 11.87 & 1883.52 \\ & \textbf{8:2} & \textbf{757.53} & \textbf{3.53} & \textbf{551.76} \\ & 9:1 & 976.78 & 4.68 & 685.85\\
			\hline
			\multirow{2}{*}
	...
	\begin{table}[H]
		...
		\begin{tabular}{|c|c|c|c|c|}
			...
			\hline
			\multirow{2}{*}
			{LSTM} & 7:3 & 1454.65 & 3.23 & 1171.78 \\ & \textbf{8:2} & \textbf{1105.64} & \textbf{2.28} & \textbf{862.08} \\ & 9:1 & 1229.90 & 2.24 &  906.03\\
			\hline
			\multirow{2}{*}
			{GRU} & 7:3 & 1001.01 & 2.06 & 745.65 \\ & \textbf{8:2} & \textbf{939.75} & \textbf{1.84} & \textbf{697.10} \\ & 9:1 & 1142.09 & 2.17 & 885.35\\
			\hline
			\multirow{2}{*}
			{MPL} & 7:3 &  &  &  \\ & 8:2 &  &  &  \\ & \textbf{9:1} & \textbf{} & \textbf{} & \textbf{}\\
			\hline
